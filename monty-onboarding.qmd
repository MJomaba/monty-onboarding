...
-   *dust* deals with efficient parallel computation, *mcstate* was an inference-for-odin-model package
...
- More ideas have emerged since but hindered by original architecture
  - adaptive algorithm
...
Abstract (parameter) space with a density function for which we want to sample from
:::
::::::
